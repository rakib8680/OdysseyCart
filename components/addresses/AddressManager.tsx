      ...
      <div className="flex items-center justify-between mb-4">
        <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-slate-100 dark:bg-slate-800 text-[11px] sm:text-xs font-medium text-slate-600 dark:text-slate-300">
          ...
          <strong className="text-slate-900 dark:text-white font-semibold">
            {addresses.length} of 5
          </strong>
        </span>
        {addresses.length < 5 && (
          <button
            onClick={handleAdd}
            className="inline-flex items-center gap-1.5 px-3 sm:px-3.5 py-1.5 bg-slate-900 dark:bg-emerald-600 text-white text-xs sm:text-sm font-semibold rounded-lg hover:bg-emerald-600 dark:hover:bg-emerald-500 transition-colors cursor-pointer"
          >
